...
export class HeatmapData {
    ...
    static new(width, height) {
        const ret = wasm.heatmapdata_new(width, height);
        return HeatmapData.__wrap(ret);
    }
    /**
     * @returns {number}
     */
     ...
     */
    set_value(x, y, value) {
        wasm.heatmapdata_set_value(this.__wbg_ptr, x, y, value);
    }
    update() {
        wasm.heatmapdata_update(this.__wbg_ptr);
    }
    /**
     * @returns {Uint8Array}
     */
    get_data() {
        try {
            ...
            wasm.heatmapdata_get_data(retptr, this.__wbg_ptr);
    ...
    get_row_data(y) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.heatmapdata_get_row_data(retptr, this.__wbg_ptr, y);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
